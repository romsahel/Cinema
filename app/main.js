...
require('./lib/log')(pjson.productName || 'Cinema')
...
app.setName(pjson.productName || 'Cinema')
...
function initialize()
{
    ...
    ipc.on('context-menu', function (event, template)
    {
        var result = {};
        ...
        event.sender.send('context-menu-response', result.obj);
    });
    ...
    ipc.on('__ELECTRON_LOG__', onRendererLog);
