...
function showDetail(elt)
{
  ...
  $("#detail-title").text(current.name);
  $("#detail-year").text(current.year);
  $("#detail-duration").text(current.duration + ' min');
  $("#detail-genres").text(current.genres);
  $("#detail-description").text(current.overview);
...
function debug()
{
  addMedia('527773278', {'duration': '30', 'overview': 'A lot of girls move to New York City to "make it". Max and Caroline are just trying to make their rent. In this fun, outrageous comedy series, two girls from very different backgrounds – Max, poor from birth, and Caroline, born wealthy but down on her luck – wind up as waitresses in the same colorful Brooklyn diner and strike up an unlikely friendship that could lead to a successful business venture. All they need to do is come up with $250,000 in start-up expenses. "2 Broke Girls" infuses the classic comedy with something new, current and young, proving life can be fun – even if you’re broke.', 'img': '-27230530', 'imdb': 'tt1845307', 'year': '2011', 'genres': 'Comedy', 'name': '2 Broke Girls Season 2', })
  addMedia('-479429750', {'duration': '30', 'overview': 'A lot of girls move to New York City to "make it". Max and Caroline are just trying to make their rent. In this fun, outrageous comedy series, two girls from very different backgrounds – Max, poor from birth, and Caroline, born wealthy but down on her luck – wind up as waitresses in the same colorful Brooklyn diner and strike up an unlikely friendship that could lead to a successful business venture. All they need to do is come up with $250,000 in start-up expenses. "2 Broke Girls" infuses the classic comedy with something new, current and young, proving life can be fun – even if you’re broke.', 'img': '-27230530', 'imdb': 'tt1845307', 'year': '2011', 'genres': 'Comedy', 'name': '2 Broke Girls Season 3', })
